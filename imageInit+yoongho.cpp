...
void playGround::imageInitYoongho()
{
	...
	IMAGEMANAGER->addFrameImage("ª°««¿œ∂ß", "image/ui/playericon.bmp", 126, 72, 2, 1, false, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("∫∏Ω∫√º∑¬πŸ", "image/ui/bossbar.bmp", 576, 96, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("±◊≥…≈ÿΩ∫∆Æ", "image/ui/text.bmp", 864, 96, 4, 1, true, RGB(255, 0, 255));

	IMAGEMANAGER->addImage("∫∏Ω∫≈ÿΩ∫∆Æ", "image/ui/bosstext.bmp", 168, 24, true, RGB(255, 0, 255));
}